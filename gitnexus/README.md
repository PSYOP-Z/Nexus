...
TypeScript, JavaScript, Python, Java, C, C++, C#, Go, Rust, PHP, Kotlin, Swift, Ruby, Zig
...
Some optional language grammars (Dart, Kotlin, Swift, Zig) require native compilation. If they fail, GitNexus still works — those languages will be skipped.
