export const en = {
  ...
  'tool.usage.query': 'Usage: gitnexus query <search_query>  or  gitnexus query -q, --query <search_query>',
  ...
  'help.option.impact.limit': 'Max upstream/downstream results to return',
